...
$query_total = $db->query("SELECT * FROM barang $where");
            ...
            <div class="card h-100 border-0 shadow-lg position-relative overflow-hidden group-hover-effect" 
                ...
                <div class="card-body p-4 d-flex flex-column text-start">
                    ...
                    <div class="mt-auto">
                        ...
                        <?php else: ?>
                            <a href="#" onclick="alert('Barang berhasil dimasukkan ke keranjang!'); return false;" class="btn btn-teal w-100 py-2 fw-bold shadow-sm" style="border-radius: 6px; letter-spacing: 1px; transition: 0.3s; text-decoration: none;">
                                ADD TO CART
                            </a>
                        <?php endif; ?>
                    </div>
